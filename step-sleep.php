			...
			<div class="wrapper">
				<div class="step">
					<ul class="list-inline">
						<li class="list-inline-item"><a href="step-energylevel.php"><i class="fa fa-angle-left"></i> Previous step</a></li>
						<li class="list-inline-item"><span>13/20</span></li>
					</ul>
					<div class="line-step">
						<div class="check-line" style="width: 65%;"></div>
					</div>
				</div>
				<div class="title">
